...
const InviteCodeInputScreen: React.FC = () => {
  ...
  useEffect(() => {
    // Auto-focus input after screen mounts
    setTimeout(() => {
          ...
          <View style={styles.tipContainer}>
            <LinearGradient
              ...
              <Text style={styles.tipText}>
                You can copy and paste the invite code from a message or email
              </Text>
            </LinearGradient>
          </View>
        </View>
...
export default InviteCodeInputScreen;
